...
export VIRTUALENVWRAPPER_VIRTUALENV=/home/imdad/.local/bin/virtualenv
export WORKON_HOME=$HOME/.virtualenvs
export PROJECT_HOME=$HOME/Projects
source /home/imdad/.local/bin/virtualenvwrapper.sh
...
function backup() {
  sudo rsync -aAXv --exclude={"/dev/*","/proc/*","/sys/*","/tmp/*","/run/*","/mnt/*","/media/*","/lost+found"} / /media/imdad/Backup/ubuntu
}
